    ...
    for dataset_dir in dataset_list:
        for size in resize_list:
            ...
            for data_path in data_list:
                save_dir = join(result_dir, '_'.join(os.path.dirname(data_path).split('/')[3:5]) + '_mod' + str(mod_idx))
                ...
                print('Super-resolutioning... model_num: {:1}, src: {}'.format(mod_idx, data_path))
